...
**That design was superseded on 2026-08-20** by a new plan that builds on Agent Orange as the
...
The live, authoritative plan is `design/2026-08-20-agent-wolf.md` in the **agent-orange** repo.
Start there.
